...
public class OrderMessageSender {
    ...
    public void sendOrderCreated(Order order) {
        ...
        try {
            OrderMessageDTO message = OrderMessageDTO.builder()
                    ...
                    .username(order.getUserName() != null ? order.getUserName() : "")
                    .userPhone(order.getUserPhone() != null ? order.getUserPhone() : "")
    ...
    public void sendOrderPaid(Order order) {
        ...
        try {
            ...
            log.info("发送到交换机: {}, 路由键: {}",
                    RabbitMQConfig.ORDER_EXCHANGE, RabbitMQConfig.ROUTING_KEY_PAY);
    ...
    public void sendOrderCancelled(Order order) {
        ...
        try {
            OrderMessageDTO message = OrderMessageDTO.builder()
                    ...
                    .cancelReason(order.getCancelReason() != null ? order.getCancelReason() : "用户主动取消")
